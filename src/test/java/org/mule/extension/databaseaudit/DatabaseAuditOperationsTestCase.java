package org.mule.extension.databaseaudit;
...
public class DatabaseAuditOperationsTestCase extends MuleArtifactFunctionalTestCase {
...
//  @Test
//  public void executeLogMessageOperation() throws Exception {
//    String payloadValue = ((String) flowRunner("logMessageFlow").run()
//            .getMessage()
//            .getPayload()
//            .getValue());
